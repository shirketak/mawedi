...
@section('page-title', 'نمو المستخدمين')
            ...
            <div class="col-12 col-sm-4 col-md-3">
                ...
                <select name="months" class="form-select" onchange="this.form.submit()">
                    @foreach([6, 12, 18, 24] as $option)
                        <option value="{{ $option }}" @selected($months === $option)>{{ $option }} شهر</option>
                    @endforeach
                </select>
            </div>
        </form>
...
<div class="card">
    <div class="card-header bg-white"><h6 class="mb-0">نمو مستخدمي التطبيق</h6></div>
...
new Chart(document.getElementById('reportChart'), {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderColor: '#3E9B52',
            backgroundColor: 'rgba(62, 155, 82, 0.1)',
            fill: true,
            tension: 0.3
        }]
    },
